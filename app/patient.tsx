...
const ALERT_BADGE_CLASS = {
  ...
  resolved: 'bg-emerald-100 text-emerald-700 dark:bg-emerald-400/20 dark:text-emerald-200',
} as const;
      ...
      <View className={cn('gap-6 px-6 pb-16 pt-8', isWeb && 'items-center py-16')}>
        ...
        >
          ...
          >
            ...
            >
              <Icon materialCommunityIcon={{ name: 'alert-circle' }} className="text-white" />
            ...
            {patientDetail.metrics.map((metric) => (
              <View
                ...
                className={cn(
                  ...
                  isWeb &&
                    'web:rounded-2xl web:border-white/70 web:bg-white web:shadow-sm web:shadow-primary/5'
                )}
              >
        ...
        <View className="gap-3">
          ...
          <View className={cn('gap-3', isWeb && 'web:grid web:grid-cols-2 web:gap-5')}>
